...
# Data from fully-resolved simulations using Momentum-Exchange-Method (DPS)
DPS_Re32_2 = ParticleData('./trajectories/particle0000001.dat', 'DPS')
...
EXP_32_2 = ExperimentalParticleData('./reference_data/tencate_Re32_2.csv', 'Ten Cate')

fig, ax = plt.subplots()
DPS_Re32_2.plot_trajectory(fig, ax, '-',clrs[0])
...
plt.tight_layout()
plt.savefig(f'tencate_DPS_RE32_EXP.png')
