...
DPS_Re4_1 = ParticleData('./trajectories/particle0000001.dat', 'DPS')
...
EXP_4_1 = ExperimentalParticleData('./reference_data/tencate_Re4_1.csv', 'Ten Cate')

fig, ax = plt.subplots()
DPS_Re4_1.plot_trajectory(fig, ax, '-',clrs[0])
EXP_4_1.plot_trajectory(fig, ax,'',clrs[0])
...
plt.tight_layout()
plt.savefig(f'tencate_DPS_RE4_EXP.png')
