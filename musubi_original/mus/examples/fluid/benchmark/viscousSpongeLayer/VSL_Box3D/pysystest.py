__pysys_title__   = r""" Viscous sponge layer with 3D box """ 
#                        ==========================
__pysys_purpose__ = r""" Testing the viscous sponge layer with 3D box layout """ 
...
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    ...
    def validate(self):
        ...
        trackfile = 'pulse3D_probe_p00000.res'
