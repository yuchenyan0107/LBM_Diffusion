__pysys_title__   = r""" Viscous sponge layer with plane """ 
#                        ==========================
__pysys_purpose__ = r""" Testing the viscous sponge layer with plane layout """ 
...
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    ...
    def validate(self):
        ...
        trackfile = 'acousticLineSrc_line_p00003_t13.988E-03.res'
