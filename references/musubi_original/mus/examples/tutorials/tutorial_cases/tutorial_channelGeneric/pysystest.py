__pysys_title__   = r""" Tutorial: Channel flow """ 
#                        ==========================
__pysys_purpose__ = r""" Ensure that the setups from the tutorials work """ 
...
__pysys_reference_dir__ = "reference"
...
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    ...
    def validate(self):
        ...
        trackfile = 'channel_probeAtCenter_p00000.res'
