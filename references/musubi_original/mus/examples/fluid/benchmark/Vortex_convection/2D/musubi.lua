...
divider = 5 -- 1 mean M=0.2, 5 M=0.04
-- Lattice Mach number
Ma = 0.2/divider
...
interpolation_method = {
  method = 'quadratic', --'weighted_average',
...
tracking = {
  -- Output file to visualize in Paraview.
  {
    label = 'vtk',
    folder = 'tracking/',
    variable = { 'pressure_phy','velocity_phy', 'density_phy', 'grad_velocity' },
    shape = { kind = 'all' },
    time_control = { min= 0, max = tmax_phy, interval = tmax_phy/10 },
    output = { format = 'vtk' }
  }
}
--! [Tracking]
