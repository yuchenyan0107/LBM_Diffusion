__pysys_title__   = r""" Tencate setup for MEM particle modelling Re=11e6""" 
#                        ==========================
__pysys_purpose__ = r""" Basic particle test """ 
...
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    def setup(self):
        ...
        self.apes.setupMusubi(musfile = 'musubi_recheck.lua')
    ...
    def validate(self):
        ...
        trackfile = 'particle0001.dat'
        self.assertPathExists(trackfile, abortOnError = True)
        self.apes.assertIsClose(trackfile, loadtxt_args = {'skiprows': 2})
