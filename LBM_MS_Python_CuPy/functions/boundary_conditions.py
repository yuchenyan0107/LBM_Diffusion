...
def lattice_flow_object_inlet_outlet(f, phi, step, non_absorb_mask, bc_top, bc_bottom, vx):
    # cylinder object with no-slip condition
    # top and bottom walls with no-slip condition
    ...
    ux_in = xp.ones(f_streamed.shape[3]) * vx
